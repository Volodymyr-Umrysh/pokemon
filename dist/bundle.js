...
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! exports provided: getPokemonIdFromUrl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getPokemonIdFromUrl\", function() { return getPokemonIdFromUrl; });\nfunction getPokemonIdFromUrl(url){\r\n    const startIndex = url.lastIndexOf('pokemon/')\r\n   return url.slice(startIndex + 'pokemon/'.length).slice(0,-1)\r\n}\n\n//# sourceURL=webpack:///./src/helpers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _network__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./network */ \"./src/network.js\");\n/* harmony import */ var _generateHtml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./generateHtml */ \"./src/generateHtml.js\");\n\r\n\r\n\r\nconst listContainer = document.querySelector('.pokemon-list-container')\r\nconst loadMoreButton = document.getElementById('load-more')\r\nconst specificPokemonContainer = document.querySelector('.detail-info')\r\nlet nextUrl = null\r\n\r\nObject(_network__WEBPACK_IMPORTED_MODULE_0__[\"getPokemonList\"])()\r\n    .then(res => {\r\n        nextUrl = res.data.next\r\n        Object(_generateHtml__WEBPACK_IMPORTED_MODULE_1__[\"generatePokemonList\"])(res.data, listContainer)\r\n    })\r\n\r\n listContainer.addEventListener('click', (e) => {\r\n        const pokemonCardBox = e.target.closest('.pokemon')\r\n        if(pokemonCardBox){\r\n            const pokemonId = pokemonCardBox.dataset.id\r\n            Object(_network__WEBPACK_IMPORTED_MODULE_0__[\"getSpecificPokemonById\"])(pokemonId)\r\n                .then(res => {\r\n                    specificPokemonContainer.innerHTML = ''\r\n                const pokemonCard = Object(_generateHtml__WEBPACK_IMPORTED_MODULE_1__[\"generateSpecificPokemon\"])({\r\n                        name : res.data.name,\r\n                        typeArray: res.data.types,\r\n                        id: res.data.id,\r\n                        statsArray:res.data.stats\r\n                    })\r\n                    specificPokemonContainer.appendChild(pokemonCard)\r\n                \r\n                })\r\n        }\r\n })\r\n \r\n\r\n\r\n loadMoreButton.onclick = function(e){\r\n    Object(_network__WEBPACK_IMPORTED_MODULE_0__[\"getPokemonList\"])(nextUrl)\r\n        .then(res => {\r\n            nextUrl = res.data.next\r\n            Object(_generateHtml__WEBPACK_IMPORTED_MODULE_1__[\"generatePokemonList\"])(res.data, listContainer)\r\n        })\r\n }\r\n\n\n//# sourceURL=webpack:///./src/index.js?");
...
/*!************************!*\
  !*** ./src/network.js ***!
  \************************/
/*! exports provided: getPokemonList, getSpecificPokemonById, getPokemonType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getPokemonList\", function() { return getPokemonList; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getSpecificPokemonById\", function() { return getSpecificPokemonById; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getPokemonType\", function() { return getPokemonType; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n\r\n\r\nfunction getPokemonList(nextUrl){\r\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(nextUrl? nextUrl:'http://pokeapi.co/api/v2/pokemon/?limit=12')\r\n}\r\n\r\nfunction getSpecificPokemonById(id){\r\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`http://pokeapi.co/api/v2/pokemon/${id}`)\r\n}\r\n\r\nfunction getPokemonType(type){\r\n    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`http://pokeapi.co/api/v2/type/?limit=999`)\r\n    \r\n    \r\n}\r\n\r\n\r\n/*const url = 'http://pokeapi.co/api/v2/type/?limit=999'\r\naxios.get(url)\r\n  .then(response => console.log(response));\r\n\r\n\r\n  const url1 = 'http://pokeapi.co/api/v2/pokemon/?limit=12'\r\naxios.get(url1)\r\n  .then(response => console.log(response));*/\n\n//# sourceURL=webpack:///./src/network.js?");
